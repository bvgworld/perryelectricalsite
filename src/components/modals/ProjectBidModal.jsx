...
const ProjectBidModal = ({ isOpen, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await addDoc(collection(db, 'leads', 'projectBids'), {
      ...
      console.error('Error submitting project bid:', err);
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Talk to an Estimator" size="lg">
