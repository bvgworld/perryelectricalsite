...
const CeilingFans = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Ceiling Fan Installation | Perry Electrical - Kansas</title>
        <meta 
          name="description" 
          content="Professional ceiling fan installation, wiring, and replacement in Kansas. Improve air circulation and energy efficiency with expert ceiling fan services." 
        />
      </Helmet>
        ...
        <Container>
          <Card className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Improve comfort and energy efficiency with professional ceiling fan installation.
            </p>
