...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent-dark via-primary-blue to-secondary-green flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      {/* Background Pattern */}
